...
const Single_Service_Card = ({ name, description,imgSrc }) => {
  return (
    <>
      <section className="max-w-sm border border-dashed rounded-xl shadow-xl p-4 hover:bg-blue-400">
        <div className="flex items-center gap-2 mb-4">
          <span className="w-10 h-10  flex justify-center items-center rounded-full">{imgSrc}</span>
        ...
        <div className="flex gap-5 mt-2">
          ...
          >
            <MdOutlineWatchLater className="text-blue-600" />
          ...
          >
            <CiBadgeDollar className="text-blue-600" />
            <span className="flex-1 ms-2 whitespace-nowrap text-blue-600">
              65
            </span>
          </a>
        </div>
