...
const Single_Profile_Card = ({ imgSrc, name, title }) => {
  ...
  <>
   <div
      className={`group hover:saturate-100 saturate-0 transition-[filter] relative w-[248px] h-[318px] bg-[#FAEDE4] font-['Robot_Flex'] border-b-2  border-b-[#F04E29]`}
